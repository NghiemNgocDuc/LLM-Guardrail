...
// Legacy email/password auth payloads — endpoints were removed from the backend
// (migrated to Clerk) but the UI still targets them.
  ...
  async function submit() {
    ...
    try {
      if (tab === "login") {
        ...
        // Legacy password auth is gone (Clerk OAuth owns sessions); tokens now
        // come from the Clerk provider wired in App.tsx.
        setTokens();
