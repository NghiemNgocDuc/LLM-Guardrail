...
const s = {
  ...
  main: { flex: 1, minWidth: 0, overflow: "auto", padding: 32, maxWidth: 1520, margin: "0 auto", position: "relative", zIndex: 1 },
  pageTitle: {
  ...
  statValue: { fontSize: 32, fontWeight: 850, marginTop: 6, color: "#102033", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", wordBreak: "break-word", minWidth: 0 },
  ...
  sectionTitle: {
    fontSize: 13, fontWeight: 800, letterSpacing: 0, color: "#27394f",
    marginBottom: 16
  },
  table: { width: "100%", borderCollapse: "collapse" },
  th: {
    textAlign: "left", padding: "10px 12px", fontSize: 11, color: "#7b8a9d",
          ...
          <ResponsiveContainer width="100%" height={180}>
            <AreaChart data={time_series} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
              ...
              <Tooltip contentStyle={{
                background: "#ffffff", border: "1px solid #dce7f0",
            ...
            <tbody>
              {provider_usage.length === 0 ? (
                ...
                <tr key={`${p.backend}:${p.model}`}>
                  ...
                  <td style={{
                    ...s.td, maxWidth: 180, overflow: "hidden",
              ...
              {recent_suspicious.length === 0 ? (
                ...
                <tr key={log.id}>
                  ...
                  <td style={{
                    ...s.td, maxWidth: 180, overflow: "hidden",
                    textOverflow: "ellipsis", whiteSpace: "nowrap"
                  }}>{log.prompt_preview}</td>
                  <td style={{
                    ...s.td, maxWidth: 160, overflow: "hidden",
                    textOverflow: "ellipsis", whiteSpace: "nowrap"
                  }}>{log.reason || log.fired_rule || "-"}</td>
          ...
          <tbody>
            ...
            {recent_logs.slice(0, 10).map(log => (
              <tr key={log.id}>
                <td style={s.td}><span style={s.badge(log.status)}>{log.status}</span></td>
                <td style={{
                  ...s.td, maxWidth: 200, overflow: "hidden",
                  textOverflow: "ellipsis", whiteSpace: "nowrap"
                }}>{log.prompt_preview}</td>
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
        ...
        <div style={{
          marginLeft: "auto", fontSize: 12, color: "#607086", fontWeight: 750,
          alignSelf: "center"
        }}>{total} total</div>
      </div>
          ...
          <tbody>
            {logs.map(log => (
              <tr key={log.id}>
                <td style={s.td}><span style={s.badge(log.status)}>{log.status}</span></td>
                <td style={{
                  ...s.td, maxWidth: 220, overflow: "hidden",
                  textOverflow: "ellipsis", whiteSpace: "nowrap"
                }}
      ...
      <div style={s.card}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(150px,1fr))", gap: 10, marginBottom: 16 }}>
          {["Client precheck", "Input policy", "Provider call", "Output policy"].map((step, idx) => (
            <div key={step} style={{
              border: "1px solid #dce7f0", background: "#f8fbff",
              ...
              <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
                {[
                  ...
                  <div key={label} style={{
                    ...
                    <div style={{
                      fontSize: 12, color: g.passed ? "#067647" : "#be123c",
  ...
  return (
    <div>
      ...
      <div style={{ ...s.card, marginTop: 16 }}>
        ...
        <pre style={{
          margin: 0, fontSize: 12, lineHeight: 1.5, padding: 14, background: "#f1f5f9",
